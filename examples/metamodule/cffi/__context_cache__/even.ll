...
@".const.<numba.core.cpu.CPUContext object at 0x7fff7d7c5e00>" = internal constant [53 x i8] c"<numba.core.cpu.CPUContext object at 0x7fff7d7c5e00>\00"
@_ZN08NumbaEnv8test_ffi7add_oneB2v7B38c8tJTIeFIjxB2IKSgI4CrvQClQZ6FczSBAA_3dE7void_2ax28Literal_5bbool_5d_28False_29x = common local_unnamed_addr global ptr null
...
B0.else.if:
  ...
  %.98 = icmp eq i64 %0, 0
  br i1 %.98, label %B48.endif, label %B134.endif

common.ret:                                       ; preds = %B134.endif, %B48.endif
  %storemerge = phi i64 [ %.169, %B134.endif ], [ %.135, %B48.endif ]
  store i64 %storemerge, ptr %retptr, align 8
  ret i32 0

B48.endif:                                        ; preds = %B0.else.if
  %.19.1 = ashr i64 %arg.arg1, 1
  %.17.i = sitofp i64 %.19.1 to float
  %.20.i = tail call float @_TYPEMAGICNAddOne6CallFnE(ptr %arg.ctx, float %.17.i, i8 0, float %.17.i), !noalias !0
  %.132 = fpext float %.20.i to double
  %.134 = fadd double %.132, 1.000000e+00
  %.135 = fptosi double %.134 to i64
  br label %common.ret

B134.endif:                                       ; preds = %B0.else.if
  %.5.i = tail call i32 @_TYPEMAGICNAddIt6CallFnE(ptr %arg.ctx), !noalias !3
  %.167 = sext i32 %.5.i to i64
...
.23:                                              ; preds = %entry.if.endif, %entry.if.endif.endif.endif, %entry.if.endif.if
  %.71 = call ptr @PyUnicode_FromString(ptr nonnull @".const.<numba.core.cpu.CPUContext object at 0x7fff7d7c5e00>")
...
declare float @_TYPEMAGICNAddOne6CallFnE(ptr, float, i8, float) local_unnamed_addr
...
!0 = !{!1}
!1 = distinct !{!1, !2, !"_ZN8test_ffi7add_oneB2v7B38c8tJTIeFIjxB2IKSgI4CrvQClQZ6FczSBAA_3dE7void_2ax28Literal_5bbool_5d_28False_29x: %retptr"}
!2 = distinct !{!2, !"_ZN8test_ffi7add_oneB2v7B38c8tJTIeFIjxB2IKSgI4CrvQClQZ6FczSBAA_3dE7void_2ax28Literal_5bbool_5d_28False_29x"}
!3 = !{!4}
!4 = distinct !{!4, !5, !"_ZN8test_ffi6add_itB2v2B38c8tJTIeFIjxB2IKSgI4CrvQClQZ6FczSBAA_3dE7void_2a: %retptr"}
!5 = distinct !{!5, !"_ZN8test_ffi6add_itB2v2B38c8tJTIeFIjxB2IKSgI4CrvQClQZ6FczSBAA_3dE7void_2a"}
