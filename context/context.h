...
namespace context
{
    ...
    struct SimpleModule
    {
        ...
        struct ImplFor
        {
            ...
            typedef typename container::TypeArray<
                container::TypeMap<>, container::TypeMap<container::Binding<IMPL, typename ReqSet::SetType>>>::template ItemAt<(size_t)TRAIT_VALID>::type type;
        };
    };
    ...
    */
    ...
    struct ContextSolveGuard<true, PRUNED_DEP_MAP, CHECK, SOLVER>
    {
        ...
        typedef typename container::TypeMap<container::Binding<ContextInfo, Meta<ContextInfoImpl<CHECK>::template Impl>>>::template LossyCombine<typename Solution::TraitMap>::type TraitMap;

        typedef typename container::TypeSet<Meta<ContextInfoImpl<CHECK>::template Impl>>::template Union<typename Solution::ComponentSet>::type ComponentSet;
